...
class UrbanRoutesPage:
    ...
    driver_header = (By.XPATH, "//div[contains(@class,'order-header-title') and contains(text(),'El conductor llegará')]")
...
class TestUrbanRoutes:
    ...
    def test_name_of_conductor_appears(self):
        ...
        driver_name = WebDriverWait(self.driver, 60).until(EC.visibility_of_element_located(self.routes_page.driver_header))
